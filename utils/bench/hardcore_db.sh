#!/usr/bin/env bash
#
# run_hardcore.sh - Run HARDCORE benchmark (10M inserts + 100k random GETs)
#
# This script builds and executes the bench_db_hardcore benchmark.
...
BENCHMARK="${BENCHMARK:-bench_db_hardcore}"
RESULTS_DIR="${ROOT_DIR}/tests/benchmarks/results"

echo "========================================"
echo "          HARDCORE Benchmark"
echo "========================================"
echo
