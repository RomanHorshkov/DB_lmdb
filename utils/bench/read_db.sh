#!/usr/bin/env bash
#
# run_bench3.sh - Run batched vs non-batched GET benchmark
#
# This script builds and executes the bench_db_get_batch benchmark.
...
BENCHMARK="${BENCHMARK:-bench_db_get_batch}"
RESULTS_DIR="${ROOT_DIR}/tests/benchmarks/results"

echo "========================================"
echo "Database GET Benchmark Runner"
echo "========================================"
echo
